...
function UserEmailNew(props: Props) {
  const { errorMessage, isPending, addUserEmail, someVariableToHideSignUpInfoChangeMe } = props;
  ...
  return (
    <Form onSubmit={handleSubmit}>
      ...
      />
      {!someVariableToHideSignUpInfoChangeMe && (
        <FormField
          type="checkbox"
          id="sign_up_sync"
      ...
      {/* {someVariableToHideSignUpInfoChangeMe ? (
        <p className="help">
          ...
          <Button button="link" label={__('Sign Up')} navigate={`/$/${PAGES.AUTH}/signup`} />
        </p>
      ) : (
        <p className="help">
          {__('Already have an account?')}{' '}
          <Button button="link" label={__('Sign In')} navigate={`/$/${PAGES.AUTH}/signin`} />
        </p>
      )} */}
    </Form>
  );
